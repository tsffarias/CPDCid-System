'''
Arvore AVL
Referencia 1: https://youtu.be/lxHF-mVdwK8
'''
...
class AVLTree:
	...
	def relatorio_intervalo_tempo(self, ano_inicial, ano_final):
		if self.root != None:
			...
			print('Arvore AVL vazia')
	
	def _relatorio_intervalo_tempo(self, cur_node, ano, padrao_placa):
		if cur_node != None:
			self._relatorio_intervalo_tempo(cur_node.left_child, ano, padrao_placa)
			...
			self._relatorio_intervalo_tempo(cur_node.right_child, ano, padrao_placa)
	...
	def _relatorio_estadual_final_placa(self, cur_node, uf, padrao_placa):
		if cur_node != None:
			self._relatorio_estadual_final_placa(cur_node.left_child, uf, padrao_placa)
			if cur_node.car.estado == uf.upper() and cur_node.car._padrao_placa.lower() == padrao_placa:
				self.carro_info(cur_node.car)
			self._relatorio_estadual_final_placa(cur_node.right_child, uf, padrao_placa)
