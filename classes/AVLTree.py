...
class AVLTree:
	...
	def _relatorio_intervalo_tempo(self, cur_node, ano):
		if cur_node != None:
			self._relatorio_intervalo_tempo(cur_node.left_child, ano)
			if int(cur_node.car.ano_frabricacao) == int(ano):
				self.carro_info(cur_node.car)
			self._relatorio_intervalo_tempo(cur_node.right_child, ano)
	...
	def _relatorio_estadual_final_placa(self, cur_node, uf):
		if cur_node != None:
			self._relatorio_estadual_final_placa(cur_node.left_child, uf)
			if cur_node.car.estado == uf.upper():
				self.carro_info(cur_node.car)
			self._relatorio_estadual_final_placa(cur_node.right_child, uf)
